...
cross_val = True
if cross_val:
    W = np.load('Cross_val_weights.npy')
else:
...
print("\033[1;36;40m13. OT --> NN       ==>        W + V_OT + W_NN > \u03F4   |  ", "\033[1;32;40mTrue" if (W[0] + W[5] + W[6] > W[10]) else "\033[1;31;40mFalse")
print("\033[1;36;40m14. OT --> DT       ==>        W + V_OT + W_DT > \u03F4   |  ", "\033[1;32;40mTrue" if (W[0] + W[5] + W[7] > W[10]) else "\033[1;31;40mFalse")
print("\033[1;36;40m15. OT --> JJ       ==>        W + V_OT + W_JJ > \u03F4   |  ", "\033[1;32;40mTrue" if (W[0] + W[5] + W[8] > W[10]) else "\033[1;31;40mFalse")
print("\033[1;36;40m16. OT --> OT       ==>        W + V_OT + W_OT > \u03F4   |  ", "\033[1;32;40mTrue" if (W[0] + W[5] + W[9] > W[10]) else "\033[1;31;40mFalse\033[0")
